...
export interface ApiEventsFeedEventsFeed extends Struct.CollectionTypeSchema {
  collectionName: 'events_feeds';
  info: {
    displayName: 'Events Feed';
    pluralName: 'events-feeds';
    singularName: 'events-feed';
  };
  options: {
...
export interface ApiMemberStoryMemberStory extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Member Stories';
    pluralName: 'member-stories';
    singularName: 'member-story';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::member-story.member-story'
    > &
      Schema.Attribute.Private;
    memberName: Schema.Attribute.String;
    posterImage: Schema.Attribute.Media<'images' | 'files'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTreasureHuntLinkTreasureHuntLink
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::treasure-hunt-link.treasure-hunt-link'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
